    ...
    <head>
        ...
        <style>
            * { box-sizing: border-box; }
            ...
            .card { border: 2px solid #74ee8c; border-radius: 12px; padding: 24px; }
            .row { display: flex; justify-content: space-between; }
            .muted { color: #6b7280; }
            .title { font-size: 22px; font-weight: 700; color: #16a34a; }
            .h1 { font-size: 20px; font-weight: 700; margin: 0; }
            .logo { width: 88px; height: 88px; object-fit: contain; margin-bottom: 12px; }
            .logo-placeholder { width: 88px; height: 88px; background: #f3f4f6; border-radius: 8px; text-align: center; line-height: 88px; color: #9ca3af; margin-bottom: 12px; }
            .section { margin-top: 20px; }
            .table { width: 100%; border-collapse: collapse; margin-top: 12px; }
            .table th { text-align: left; border-bottom: 2px solid #111827; padding: 8px 0; }
            .table td { border-bottom: 1px solid #e5e7eb; padding: 8px 0; }
            .right { text-align: right; }
            .center { text-align: center; }
            .totals { width: 240px; margin-left: auto; margin-top: 12px; }
            .totals-row { display: flex; justify-content: space-between; padding: 6px 0; }
            .totals-row.border { border-bottom: 1px solid #e5e7eb; }
            .total { font-size: 16px; font-weight: 700; color: #16a34a; }
            .footer { border-top: 1px solid #e5e7eb; padding-top: 12px; text-align: center; margin-top: 16px; }
        </style>
    </head>
    <body>
        <div class="card">
