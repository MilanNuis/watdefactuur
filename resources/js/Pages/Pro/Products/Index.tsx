    ...
    return (
        <ProLayout>
            <div className="flex items-center justify-between">
                <Header title="Producten" description="Beheer hier je producten" />
                <CreateProductDialog />
            </div>
                ...
                <TableBody>
                    {products.data.map((product: Product) => (
                        <TableRow key={product.id}>
                            ...
                            <TableCell className="font-medium">{product.price_without_btw}</TableCell>
                            <TableCell className="font-medium">{product.btw}%</TableCell>
                            <TableCell className="font-medium">
                                {Number(product.price_without_btw) +
                                    (Number(product.price_without_btw) * Number(product.btw)) / 100}
                            </TableCell>
