    ...
    return (
        <div className="min-h-screen bg-background max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Head title="Factuur maken & versturen">
                <meta name="description" content="Maak professionele facturen in minuten. Perfect voor freelancers, ZZP'ers en kleine ondernemers." />
                <meta name="keywords" content="facturen, freelancers, ZZP'ers, ondernemers, factuur, facturen maken, facturen versturen, facturen beheren" />
            ...
            <header className="bg-card border-b border-border sticky top-0 z-10">
                <div className="container py-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-foreground">WatDeFactuur</h1>
