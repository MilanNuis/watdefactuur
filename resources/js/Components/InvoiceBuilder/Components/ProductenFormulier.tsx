        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="space-y-4">
                ...
                {invoiceData.products.length === 0 ? (
                    <div className="p-4 text-sm text-muted-foreground bg-card rounded-lg border border-border">
                            ...
                            >
                                ...
                                <div className="col-span-3 md:col-span-2 space-y-1">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) => updateProduct(product.id, { btw: parseFloat(value) || 0 })}
                                    >
                                        <SelectTrigger>
